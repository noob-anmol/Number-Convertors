    ...
    <div>
      ...
      >
        <div className="box-border">
          <label  className = "text-lg rounded-md p-3 text-indigo-600"for="Representations">Convert from</label>
          <select className="text-lg mr-3 h-12 pt-3 pb-3 pr-3" name="Representation" id="Representation">
